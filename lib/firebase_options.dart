...
class DefaultFirebaseOptions {
  ...
  static FirebaseOptions macos = FirebaseOptions(
    apiKey: dotenv.get('FIREBASE_MACOS_apiKey'),
    appId: dotenv.get('FIREBASE_MACOS_appId'),
    messagingSenderId: dotenv.get('FIREBASE_MACOS_messagingSenderId'),
    projectId: dotenv.get('FIREBASE_MACOS_projectId'),
    storageBucket: dotenv.get('FIREBASE_MACOS_storageBucket'),
    iosBundleId: dotenv.get('FIREBASE_MACOS_iosBundleId'),
  );
}
